import type { IPackageRunner } from '../packageRunner/types'
import type { PackageInfo } from '../types'
import type { ICommandDispatcher } from './types'
...
export class BasicCommandDispatcher implements ICommandDispatcher {
  ...
  public activate(): void {
    // Use the console to output diagnostic information (console.warn) and errors (console.error)
    // This line of code will only be executed once when your extension is activated
    console.warn(`Activating ${this._packageInfo.packageDisplayName} ...`)
    ...
    console.warn(`${this._packageInfo.packageDisplayName} activated.`)
  }
}
